      ...
      <div className="pointer-events-none relative z-10 flex flex-col min-h-[100dvh] pb-24">
        <header className="pt-4 px-4 pointer-events-auto">
          <div className="flex items-center gap-2 bg-white rounded-full shadow-md px-4 py-2">
            <input
              ...
              className="flex-1 bg-transparent text-[14px] placeholder:text-neutral-400 focus:outline-none"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <button
              type="button"
              className="text-[20px] text-neutral-500 px-1"
              aria-label="검색"
            >
              🔍
            </button>
            ...
            {CATEGORY_ITEMS.map((c) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "shrink-0 px-4 py-2 rounded-full text-[13px] border bg-white",
                    isActive
        ...
        <div className="pointer-events-auto fixed bottom-[70px] left-1/2 -translate-x-1/2 w-full max-w-[480px] px-4 flex flex-col gap-2">
          <div className="w-full flex flex-col items-center mb-1">
            ...
            <button
              type="button"
              className="w-full rounded-full bg-[#e64a45] text-white py-3 text-[15px] font-semibold shadow-[0_6px_16px_rgba(230,74,69,0.4)]"
              onClick={() => {
              ...
              {displayedHosts.map((host) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "min-w-[250px] max-w-[250px] rounded-2xl bg-white border text-left px-4 py-2 shadow-sm transition-all duration-150",
                      selected
                        ? "border-[#e64a45] shadow-[0_8px_16px_rgba(0,0,0,0.15)]"
                        : "border-neutral-200",
                    ].join(" ")}
                  >
